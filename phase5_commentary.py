...
while True:
    ...
    if (recent_events and
            frame_count - last_commentary_frame >= 60):
...
for c in commentary_log:
    print(f"   Frame {c['frame']}: {c['commentary']}")
print(f"\n📁 Output saved as: phase5_commentary.mp4")